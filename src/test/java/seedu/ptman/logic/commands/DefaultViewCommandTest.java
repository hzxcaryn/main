...
import static seedu.ptman.logic.commands.DefaultViewCommand.MESSAGE_SUCCESS;
...
//@@author hzxcaryn
public class DefaultViewCommandTest {
    @Rule
    public final EventsCollectorRule eventsCollectorRule = new EventsCollectorRule();

    @Test
    public void execute_main_success() {
        CommandResult result = new DefaultViewCommand().execute();
