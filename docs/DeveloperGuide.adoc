...
The timetable also instantly reflects any changes to shifts on the timetable, such as the addition/deletion of a shift, and the application/removal of an employee to/from a shift.
Furthermore, the timetable can highlight the shifts that a selected employee is assigned to.
...
image::updateTimetableViewSequenceDiagram.png[width="800"]
