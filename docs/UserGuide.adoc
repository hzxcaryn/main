...
[[Dv]]
==== Displaying the default timetable: `defaultview`

Displays the default view of the timetable. The timetable display the current week without any employee selected.
